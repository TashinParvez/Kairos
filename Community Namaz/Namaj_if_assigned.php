    ...
    <main class="main bg-transparent">
        <div class="container bg-white">
            <div class="row bg-white">
                ...
                <div class="progress w-100 z-2" role="progressbar" aria-label="Example with label" aria-valuenow="0"
            ...
            <form action="Puja.php" method="post">
                <div class="container bg-white">
                    <div class="form-check form-switch bg-white">
                        <input class="form-check-input" type="checkbox" value="morning" id="Fajr"
                            name="Fajr">
                            Fajr
                    </div>
                    <div>
                        <div class="form-check form-switch bg-white">
                            <input class="form-check-input" type="checkbox" value="evening" id="Dhuhr"
                                name="Dhuhr">
                                Dhuhr
                        </div>
                    </div>
                    <div>
                        <div class="form-check form-switch bg-white">
                            <input class="form-check-input" type="checkbox" value="evening" id="Asr"
                                name="Asr">
                                Asr
                        </div>
                    </div>
                    <div>
                        <div class="form-check form-switch bg-white">
                            <input class="form-check-input" type="checkbox" value="evening" id="Maghrib"
                                name="Maghrib">
                                Maghrib
                        </div>
                    </div>
                    <div>
                        <div class="form-check form-switch bg-white">
                            <input class="form-check-input" type="checkbox" value="evening" id="Isha"
                                name="Isha">
                                Isha
                        </div>
                    </div>
