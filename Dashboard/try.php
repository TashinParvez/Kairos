                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-6">
                                <div class="card">
                                    ...
                                    <img src="./images/01.jpg" class="card-img-top card-v" alt="">
                                    <div class="card-body">

                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam
                                            suscipit autem corporis dolorum quas vitae iste magni! Dolorum provident minima, ipsa ipsam
                                            et natus eligendi, quod veritatis, minus modi vero.</p>
