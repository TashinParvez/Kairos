            ...
            <div class="row bg-white mt-3">
                ...
                <div class="second col-sm-auto" style="position: sticky; z-index: 1000;">
                    <a style="text-decoration:none;" href=""
                        class="hover-underline-animation"><?php echo htmlspecialchars($label[0]); ?></a>
                </div>
                <?php } ?>
            </div>
            <div class="container m-0 bg-transparent p-0 mt-2" style="outline:none;">
                <div class="row bg-white m-0 mb-2" style="display: flex; align-items: flex-end;">
                    ...
                    <div class="col-lg-9 bg-white m-0 p-0" style="position: sticky; z-index: 1000;">
                        <button id="openModalInput" style="outline:none;"
                            class="form-control form-control-lg mt-3 pt-3 pb-3 d-flex align-items-center shadow"
                            type="button" placeholder="Write Your Note" aria-label=".form-control-lg example">
                            <svg class="bg-white me-2" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="noteDetails" class="form-label">Note
                                Details</label>
                            <textarea class="form-control bg-white" id="noteDetails" name="noteDetails" rows="3"
                                required></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="editNoteForm" action="DashboardMain.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="noteCreatedAt" name="noteCreatedAt"
                                style="color: inherit;" readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="container">
