...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 bg-transparent" id="exampleModalToggleLabel">Jar of Happiness</h1>
    ...
    <div id="goalButton" class="position-fixed bottom-0 end-0 mb-4 me-4 bg-transparent z-3">
        <button class="btn btn-secondary shadow" type="button" data-bs-target="#exampleModalToggle"
