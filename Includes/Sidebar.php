...
<body>
    ...
    <section class="sidebar shadow z-2">
        <div class="temp">
            <a href="/Dashboard/DashboardMain.php" style="text-decoration:none; color:black;">
                <img src="\Images\logoWithoutName.png" href="/Dashboard/DashboardMain.php">
                <p class="brand" style="text-decoration:none;">Kairos</p>
            </a>
        </div>
        <hr>
        <div class="temp">
            <div class="temp bg-white">
                <a href="/Dashboard/DashboardMain.php" type="button" class="btn btn-primary">
                    <span class="bg-white">
                        ...
                        <svg class="bg-white" width="25" height="25" viewBox="0 0 24 24" fill="none"
        ...
        <div class="temp">
            <a href="\Community\ComLanding.php" type="button" class="btn btn-primary">
                <span class="bg-white">
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="bg-white" width="25" height="25" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="temp">
            <a href="\Memories\Memories.php" type="button" class="btn btn-primary">
                <span class="bg-white">
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="bg-white" width="25" height="25" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="temp bg-white">
            <a href="/Personal Journal\Personal-Journal.php" type="button" class="btn btn-primary">
                <span class="bg-white">
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="bg-white" width="25" height="22" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                        fill="#000000" class="bi bi-journal-bookmark">
