            ...
            <div class="container pt-3 bg-white">
                <form action="Personal-Journal.php" method="POST">
                    ...
                    <div class="row justify-content-around bg-white">
                        ...
                        <div class="col bg-white">
                            <button type="button" class="btn btn-outline-secondary"><a class="bg-transparent" href="Diary.php" style="text-decoration: none; color: inherit;">All
                                    Slice</a> </button>
                            <button type="button" class="btn btn-outline-secondary"><a class="bg-transparent" href="#todaysSlices" style="text-decoration: none; color: inherit;">Today's All
                                    Slice</a> </button>
