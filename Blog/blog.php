...
?>
                        ...
                        <div class="row align-items-start mb-3 bg-white">
                            <div class="col-9 bg-white">
                                <div class="input-group bg-white" style="padding-left: 1vw;">
                                    <input type="search" class="form-control rounded bg-white"
                                        style="background-color: ;" name="search_field"
                                        value="<?php echo htmlspecialchars($search_text); ?>"
                                        placeholder="Which one you are looking for..." aria-label="search"
                                        aria-describedby="search-addon" />
                                    <button type="submit" class="btn btn-outline-primary bg-white" name="search"
                                        data-mdb-ripple-init>Search</button>
                                </div>
                            </div>
                            <div class="col-3 bg-white" style="display: grid; place-items: center;">
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    data-bs-target="#createBlogModal">Create a blog</button>
                                ...
                                <div class="row align-items-start bg-white">
                                    ...
                                    <div class="col bg-white">
                                        <a href="#" class="bg-white"
                                            style="text-decoration: none; color:black"><?php echo htmlspecialchars($blog[0]); ?></a>
                                        <br>
    ...
    <div class="modal fade bg-white z-10" id="createBlogModal" tabindex="-1" aria-labelledby="createBlogModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form action="blog.php" method="POST">
                        ...
                        <div class="mb-3 bg-transparent">
                            ...
                            <textarea class="form-control bg-white" id="blogDescription" name="blogDescription" rows="3"
                                required></textarea>
                        </div>
